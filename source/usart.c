...
void usart_0_init(void)
{
	...
	SERCOM1->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(38400))/(float)(48000000));
...
void usart_1_init(void)
{
	...
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(9600))/(float)(8000000));
	SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(38400))/(float)(48000000));
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(115200))/(float)(8000000));
...
{	
	...
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(9600))/(float)(8000000));
	SERCOM2->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(38400))/(float)(48000000));
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(115200))/(float)(8000000));
...
{	
	...
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(9600))/(float)(8000000));
	SERCOM3->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(38400))/(float)(48000000));
	//SERCOM0->USART.BAUD.bit.BAUD=65536.0f*(1.0f-(8.0*(float)(115200))/(float)(8000000));
