...
typedef struct
{
	struct
	{
		...
		struct
		{
			...
			BYTE Reserved2: 1;
			BYTE Reserved3: 1;
			BYTE Magic_Packet_Interrupt_Mask: 1;
			BYTE PPPPoE_Close_Interrupt_Mask: 1;
			BYTE Destination_unreachable_Interrupt_Mask: 1;
			BYTE IP_Conflict_Interrupt_Mask: 1;
		}R07_IMR_16;
		...
		struct
		{
			...
			BYTE SPD_1_100: 1;
			BYTE DPX_1_FULL: 1;
			BYTE OPMDC1_auto_1: 1;
			BYTE OPMDC2_auto_1: 1;
			BYTE OPMDC3_auto_1: 1;
			BYTE OPMD: 1;
			BYTE RST: 1;
		}R19_PHYCFGR_2E;
	...
	struct
	{
		...
		{
			BYTE SIZE_KByte;
		}R12_Sn_RXBUF_SIZE_1E;
		
		struct
		{
			BYTE SIZE_KByte;
		}R13_Sn_TXBUF_SIZE_1F;
